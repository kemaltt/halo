...
export interface SubtlBridge {
  ...
  setInterviewConfig: (cfg: { enabled: boolean; provider: 'claude' | 'gemini' | 'openai'; cvText: string; glossary: string; speakerLabels: boolean; ephemeral: boolean }) => Promise<void>
